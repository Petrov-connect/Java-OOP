...
public class PlayerTests {
    ...
    private static final String name1 = "colt";
    private static final String name2 = "makarov";
    private static final int bullets1 = 10;
    private static final int bullets2 = 5;
    private Gun gun1;
    private Gun gun2;
    private static final String username = "gogo";
